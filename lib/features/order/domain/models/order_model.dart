...
class Order {
  ...
  bool detailsLocked = false;
  String? restrictedAccessToken;
  String? maskedOrderReference;
  String? commerceFlowStatus;
  double? sellerInsuranceAmount;
  String? sellerInsuranceStatus;
  String? sellerInsurancePaymentStatus;
  String? sellerInsuranceExpiresAt;
  Map<String, dynamic>? shippingAssignment;
  ...
  Order.fromJson(Map<String, dynamic> json) {
    ...
    detailsLocked = json['details_locked'] == true;
    restrictedAccessToken = json['restricted_access_token']?.toString();
    maskedOrderReference = json['order_reference']?.toString();
    commerceFlowStatus = json['flow_status']?.toString() ?? json['commerce_flow_status']?.toString();
    final sellerInsurance = json['seller_insurance'] is Map ? Map<String, dynamic>.from(json['seller_insurance']) : <String, dynamic>{};
    sellerInsuranceAmount = double.tryParse('${sellerInsurance['amount'] ?? 0}');
    sellerInsuranceStatus = sellerInsurance['status']?.toString();
    sellerInsurancePaymentStatus = sellerInsurance['payment_status']?.toString();
    sellerInsuranceExpiresAt = sellerInsurance['expires_at']?.toString();
    ...
    shippingAssignment = json['shipping_assignment'] is Map
        ? Map<String, dynamic>.from(json['shipping_assignment']) : null;
  }
}
