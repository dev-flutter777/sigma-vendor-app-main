...
class AuthService implements AuthServiceInterface{
  ...
  @override
  Future sendActivationTicketMessage(String registrationReference, String body, {int? ticketId, List<XFile> attachments = const []}) => authRepoInterface.sendActivationTicketMessage(registrationReference, body, ticketId: ticketId, attachments: attachments);
