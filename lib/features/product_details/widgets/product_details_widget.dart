          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                ColorHelper.blendColors(Colors.white, Theme.of(context).colorScheme.onTertiaryContainer, 0.2) :
              ...
              child: Text(productModel!.requestStatus == 0 ? '${getTranslated('active', context)}' :
              productModel!.requestStatus == 1? '${getTranslated('approved', context)}' : '${getTranslated('denied', context)}',
                  style: robotoRegular.copyWith(
                      color: productModel!.requestStatus == 0 ?
                      Theme.of(context).colorScheme.onTertiaryContainer : productModel!.requestStatus == 1
